...
@interface WZJionStoreAndStoreHeadController ()<UITextFieldDelegate,UIScrollViewDelegate,HXPhotoViewDelegate>
//滑动页面
...
- (void)viewDidLoad {
    ...
    [self noCodeView];
    [self setManoys];
     _scrollView.contentSize = CGSizeMake(0, self.view.fHeight-60);
}
...
-(void)jionStore:(UIButton *)button{
    ...
    [WZLoadDateSeviceOne postUserInfosSuccess:^(NSDictionary *dic) {
        ...
        button.enabled = YES;
    } parament:paraments URL:@"/sysUser/companyAuthentication"];
