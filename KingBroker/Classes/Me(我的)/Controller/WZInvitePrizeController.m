...
-(void)shareRuleTask{
    ...
    labelTwo.text = @"1.所有经服用户均可邀请好友成为经服app新用户，每位用户每日分享次数不设上限。同一用户仅限一台设备登录，如同一登录设备中途更换设备参与本活动，可能无法领取红包。\n\n2.你的好友必须是从未注册过经服app的新用户，新用户下载经服app，注册并填写邀请码，成功加入门店后并且名片审核通过后视作邀请成功。（注：若通过门店编码加入门店，必须上传经纪人名片）。\n\n3.邀请成功后，经服app将会直接给你发放现金奖励，你可在“分享有奖”—“我的邀请”或“我的钱包”—“钱包明细”中查看。\n\n4.如发现恶意套取现金奖励行为，经服将有权根据情节严重程度采取相关措施：包括不限于不发放奖励、冻结所获得奖励、停止分享有奖功能、依法追究法律责任。\n\n活动的最终解释权归运营方所有，本活动和商品内容与设备生产商Apple Inc无关。";
