...
@interface WZRewardsDetilsController (){
    //页数
    NSInteger current;
}
...
@implementation WZRewardsDetilsController
...
-(void)loadData{
    ...
    paraments[@"size"] = size;
    NSString *url = [NSString stringWithFormat:@"%@/generalCapitalDetailed/getGeneralCapitalDetailed",HTTPURL];
