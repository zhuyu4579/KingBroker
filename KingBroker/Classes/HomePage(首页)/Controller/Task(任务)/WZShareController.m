...
-(void)createView:(NSDictionary *)dicty{
    ...
    layout.itemSize = CGSizeMake(155, 90);
    WZSharesCollectionView *shareCV = [[WZSharesCollectionView alloc] initWithFrame:CGRectMake(0, 0, _scrollView.fWidth, 110) collectionViewLayout:layout];
    shareCV.type = type;
    shareCV.urls = urls;
...
-(void)openCountdown{
    ...
    NSLog(@"%@",_coolingTime);
    __block NSInteger time = [_coolingTime integerValue]; //倒计时时间
