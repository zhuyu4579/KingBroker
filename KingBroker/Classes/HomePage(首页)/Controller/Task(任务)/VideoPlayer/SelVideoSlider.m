...
- (void)setup {
    [self setThumbImage:[UIImage imageNamed:@"sliding block"] forState:UIControlStateHighlighted];
    [self setThumbImage:[UIImage imageNamed:@"sliding block"] forState:UIControlStateNormal];
}
