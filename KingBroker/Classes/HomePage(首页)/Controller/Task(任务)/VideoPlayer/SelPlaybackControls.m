...
- (UIButton *)playButton
{
    if (!_playButton){
        ...
        [_playButton setImage:[UIImage imageNamed:@"big"] forState:UIControlStateNormal];
...
- (UIButton *)fullScreenButton
{
    if (!_fullScreenButton) {
        ...
        [_fullScreenButton setImage:[UIImage imageNamed:@"blowup"] forState:UIControlStateNormal];
        [_fullScreenButton setImage:[UIImage imageNamed:@"blowup"] forState:UIControlStateSelected];
